...
dt = timezone("Asia/Shanghai").localize(datetime(2025, 8, 16, 23, 30, 0, 0))
...
p.stars(where=[_.magnitude < 6.1], where_labels=[_.magnitude < 2])
...
p.horizon(labels={50: "深夜，东北方向@夜语星趴"},style__label__font_family="microsoft Yahei",)
p.gridlines()
